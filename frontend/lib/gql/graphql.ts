...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask?: { __typename?: 'Task', partyId: string, id: string, title?: string | null, status?: TaskStatus | null, description?: string | null, assignee?: { __typename?: 'Participant', name?: string | null } | null } | null };
...
export type CreatedTaskSubscriptionVariables = Exact<{
  partyId: Scalars['String']['input'];
}>;


export type CreatedTaskSubscription = { __typename?: 'Subscription', createdTask?: { __typename?: 'Task', partyId: string, id: string, title?: string | null, status?: TaskStatus | null, description?: string | null, assignee?: { __typename?: 'Participant', name?: string | null } | null } | null };
...
export type DeleteTaskMutation = { __typename?: 'Mutation', deleteTask?: { __typename?: 'Task', partyId: string, id: string } | null };
...
export type DeletedTaskSubscriptionVariables = Exact<{
  partyId: Scalars['String']['input'];
}>;


export type DeletedTaskSubscription = { __typename?: 'Subscription', deletedTask?: { __typename?: 'Task', id: string } | null };
...
export type GetTaskQuery = { __typename?: 'Query', getTask?: { __typename?: 'Task', id: string, title?: string | null, description?: string | null, status?: TaskStatus | null, assignee?: { __typename?: 'Participant', id?: string | null, name?: string | null } | null } | null };
...
export type GetTasksQuery = { __typename?: 'Query', getTasks?: { __typename?: 'Tasks', nextToken?: string | null, items?: Array<{ __typename?: 'Task', id: string, title?: string | null, description?: string | null, status?: TaskStatus | null, assignee?: { __typename?: 'Participant', name?: string | null } | null } | null> | null } | null };
...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask?: { __typename?: 'Task', partyId: string, id: string, title?: string | null, description?: string | null, status?: TaskStatus | null, assignee?: { __typename?: 'Participant', name?: string | null } | null } | null };
...
export type UpdatedTaskSubscription = { __typename?: 'Subscription', updatedTask?: { __typename?: 'Task', id: string, title?: string | null, description?: string | null, status?: TaskStatus | null, assignee?: { __typename?: 'Participant', name?: string | null } | null } | null };
...
export const CreatedTaskDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"createdTask"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createdTask"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"partyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"partyId"}},{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"assignee"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"description"}}]}}]}}]} as unknown as DocumentNode<CreatedTaskSubscription, CreatedTaskSubscriptionVariables>;
...
export const DeletedTaskDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"deletedTask"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deletedTask"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"partyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"partyId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<DeletedTaskSubscription, DeletedTaskSubscriptionVariables>;
